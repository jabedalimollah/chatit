...
const ChatUserProfile = ({ handleHideChatUser }) => {
  ...
  return (
    <>
      <div className="w-[84%] md:w-[40%] lg:w-[24%] h-screen fixed top-0 right-0 z-10 bg-white shadow-lg shadow-gray-600">
        <div className="w-full h-[8vh] bg-gray-100 flex items-center px-3 gap-x-3 text-lg font-bold">
          <button
